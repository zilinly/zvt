...
def gen_kdata_schema(pkg: str, providers: List[str], entity_type: str, levels):
    tables = []
    for level in levels:
...
from {pkg}.schemas.quotes import {kdata_common}
...
'''
    ...
    imports = [f'from {pkg}.schemas.quotes.{entity_type}.{table} import *' for table in tables]
    imports_str = '\n'.join(imports)
